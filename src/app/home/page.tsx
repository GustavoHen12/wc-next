        ...
        <>
            ...
            <PageLayout>                
                ...
                <div className='mt-8 grid grid-cols-3 gap-5'>
                    <Link href='/home/visitantes' className="bg-dark-purple rounded-3xl col-span-3 h-24 relative">
                    ...
                    <div className={`rounded-3xl col-span-2 relative ${eventos.length > 0 ? "row-span-3 h-80" : "row-span-6 h-100"}` } onClick={() => setOpenConheca(true)}>
                        <div className="absolute top-0 bg-white-purple h-full rounded-3xl z-50"></div>
                        <img src={bkg_conheca.src} className='absolute top-0 h-full w-full rounded-3xl opacity-80' />
                        <h3 className='absolute bottom-2 right-5 font-sans text-2xl z-20'>Conheça</h3>
                    </div>
                    <div className='bg-accent-green rounded-3xl h-20 flex justify-center items-center'>
                    ...
                    <div className={`bg-white-purple rounded-3xl flex flex-col justify-between items-center h-auto ${eventos.length > 0 ? "row-span-3" : "row-span-5 h-100"}`}>
                    ...
                    {
                        eventos.length > 0 ? (
                            <div className='bg-white-purple rounded-3xl h-24 col-span-2 relative' onClick={() => setOpenEventos(true)}>
